...
class Project_TSMOR_Offline(object):
    ...
    def __init__(self,u_db,Mus_db,iRef,iNbs,xarr,normalised,u_db_inlet,ng=1):
        """
        ...
        self.u_db_inlet = u_db_inlet # stores the inlet values in the case of normalised function otherise 1
